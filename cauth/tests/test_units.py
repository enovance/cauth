        ...
        with patch(to_patch) as cu:
            ...
            with patch('requests.get'):
                ...
                self.assertEqual(401,
                                 key_get.status_int)
                good_cookie = common.create_ticket(cauth_id=42, uid='user2')
                ...
                bad_cookie = common.create_ticket(cauth_id=99, uid='user3')
    ...
    def test_api_key_login(self):
        ...
        with patch(to_patch) as cu:
            ...
            with patch('requests.get') as g:
                response = self.app.post_json('/login',
                                              payload)
                good_cookie = common.create_ticket(cauth_id=123, uid='user3')
                self.app.set_cookie('auth_pubtkt', good_cookie)
                # create the API key
