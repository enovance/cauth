...
This authentication method will let the user identify herself with a user and
...
used for quick test deployments; passwords are stored in clear view and adding,
